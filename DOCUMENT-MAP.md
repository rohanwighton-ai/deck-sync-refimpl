...
| `archive/*` | historical record, moved 2026-08-16 from repo root: `WORKPLAN.md`, `RUNSHEET.md`, `HANDOVER-Q4F26-DRAFTING.md`, `WORKED-EXAMPLE-STRATEGIC-ALIGNMENT.md`, `EXPECTED-TRACE-2026-08-14.md`, `PHASE1.md`, `NEXT-SESSION-2026-08-12.md`, `PROMPT_build.md`, `PROMPT_plan.md` | HISTORICAL — never edit to match today. Anything still-useful was migrated into `SYSTEM-OVERVIEW.md` or `CHECKLIST.md` with provenance before archiving. `PROMPT_build.md`/`PROMPT_plan.md` are a different kind of archive entry — not stale facts, but unused Ralph-autonomous-loop tooling, kept in case that mode is ever restarted for this project. `NEXT-SESSION-2026-08-12.md` surfaced a real, UNRESOLVED architecture question before archiving — see `CHECKLIST.md`'s "ARCHITECTURE FORK" item. |
