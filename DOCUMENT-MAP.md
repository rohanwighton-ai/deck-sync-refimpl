...
| `MILESTONE-PERCENTAGE-DESIGN.md` | the per-milestone-percentage feature design (data model, two rendering options, geometry) | OPTION A BUILT, live verification pending — added 2026-08-22 |
