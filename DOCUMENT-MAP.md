...
| `MILESTONE-PERCENTAGE-DESIGN.md` | the per-milestone-percentage feature design (data model, two rendering options, geometry) | DESIGNED, NOT YET BUILT — added 2026-08-22 |
