...
# 2026-08-21 running this exact script against the real deck: "Sub or
# function not defined" on PreviewRealDeck.PreviewRealDeck, which doesn't
# even call IdentityCheck directly -- only RunSync does, three calls deep.
